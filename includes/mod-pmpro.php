 ...
 */
function inbound_load_inline_labels_checkout() {
    global $pmpro_pages;
...
add_action( 'wp_footer', 'inbound_load_inline_labels_checkout', 20 );
 ...
 */
function inbound_free_level_change_pmpro_level_cost_text( $text, $level ) {
...
add_filter( 'pmpro_level_cost_text', 'inbound_free_level_change_pmpro_level_cost_text', 10, 2 );
